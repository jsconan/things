...
spools = [
    ...
    define(name="prusa",  holeDiameter=45, depth=35),     // Prusa spools
    define(name="small",  holeDiameter=45, depth=25),     // Small spools
];

// Defines the constraints of the object.
spoolBrand = "generic";   // The brand of the spool to fit the sleeve on
